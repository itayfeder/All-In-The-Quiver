package com.itayfeder.all_in_the_quiver.fletching_table;
...
public class FletchingTableScreen extends AbstractContainerScreen<FletchingTableMenu> {
    private static final ResourceLocation FLETCHING_TABLE_GUI_TEXTURE = new ResourceLocation(AllInTheQuiverMod.MOD_ID, "textures/gui/fletching_table.png");
